...
import NewScootersCards from "./NewScootersCards"
    ...
    <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
      <div>
           <h2 className="mt-3 text-2xl font-semibold text-gray-900 dark:text-white text-center md:pl-4" >
            {category===""? "Find New Scooters":capitalize(category)}
          </h2>
      </div>
      {/* filter portion  */}
    ...
    <CompareBare/>
     ...
     filterBikes &&
        filterBikes.slice(2,15).map((item,index)=>
         <NewScootersCards item={item} key={index}/>
      )
     }
