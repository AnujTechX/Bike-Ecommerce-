...
import UpComingScootersCard from "./UpComingScootersCard"
import CompareBare from "../CompareBare"
import { useState } from "react"

const UpComingScooters = () => {
  ...
  const priceMatch = 
       ...
       console.log("price :",price==="gth2" && item.price_inr>200000) 
  ...
  <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
      <div>
           ...
           {category===""? "UpComing Scooters":capitalize(category)}
          </h2>
      </div>
      {/* filter portion  */}
    ...
    <CompareBare/>
       ...
       {   
     filterBikes &&
        filterBikes.slice(2,15).map((item,index)=>
         <UpComingScootersCard item={item} key={index}/>
      )
     }
...
export default UpComingScooters
