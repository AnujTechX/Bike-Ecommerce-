...
import ElectricBikesCard from "./ElectricBikesCard"
  ...
  <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div className="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
      <div>
         ...
         {category===""? "Electric Bikes" : capitalize(category) }
          </h2>
      </div>
      {/* filter portion  */}
    ...
    <div className="mb-4 mx-2 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3">
       ...
       {   
     filterBikes &&
      filterBikes.slice(1,20).map((item,index)=>
         <ElectricBikesCard item={item} key={index}/>
      )
     }
