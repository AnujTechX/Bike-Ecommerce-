  ...
  <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
       <Link to={`/product/${item.id}`}>
        ...
        <div className="pt-0">
          ...
          <button
              type="button"
              className={`flex items-center gap-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition-all duration-300 ease-in-out cursor-pointer
         ...
         <span className="border-1 w-[15px] h-[15px] inline-flex items-center justify-center flex-shrink-0"> {
          ...
          :""}
            ...
            <button  onClick={handleBooking}
              type="button"
              className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition-all duration-300 flex items-center gap-1 cursor-pointer"
            >
